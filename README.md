...
python test_reliability.py     # 22: recovery, traps, and model-violation costs
```
...
measured in the test suite rather than left as a caveat:

| departure | measured cost |
|---|---|
| five-point scale instead of a continuum | ~5% of the estimate at ρ₁ = 0.45, ~11% at 0.70 |
| raters differing in how noisy they are | ~20% at a realistic spread |
| heavy-tailed error | reliability is not defined at all; no estimator helps |

Every measured departure biases the estimate **downward**, which is the safe
...
test_reliability.py     22 tests, including six traps and two robustness costs
```
